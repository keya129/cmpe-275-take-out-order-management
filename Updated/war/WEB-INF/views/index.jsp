...
<c:out value ='${TotalAmount}'/>
			...
			<% String username = ""+(String)request.getSession().getAttribute("user"); %>
				...
				<ul class="menu-top">
				<h1>welcome: <%=(String)request.getSession().getAttribute("user") %> </h1>
  ...
  <option value="Desert">Desert</option>
							...
							<input type="hidden" name="category" id="categoryType" onfocus="this.value = 'Appetizer';" onblur="if (this.value == '') {this.value = 'Appetizer';}" value="Appetizer" />
