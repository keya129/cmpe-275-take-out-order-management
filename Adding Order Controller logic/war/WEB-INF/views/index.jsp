					...
					jQuery(document).ready(function($) {
						/*$(window).load(function(){
							...
							$('.portfolio-start .portfolio-img').each(function(e){
								...
								$('table#mytable').append('<tr class="child"><td>'+$(this).find('h4').text()+'</td>');
								$('table#mytable').append('<td>'+$(this).find('#price').text()+'</td>');
								$('table#mytable').append('<td>'+$(this).find().val('qty')+'</td></tr>');
...
<% } %>
  ...
  <option value="Desert">Desert</option>
							...
							<input type="text" name="category" id="categoryType" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'CategoryType';}" />
